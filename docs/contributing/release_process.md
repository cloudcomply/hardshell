...
**You must have `write` permissions for the _hardshell_ repository to cut a release.**
...
1. Determine the release's version number
   - **_hardshell_ follows the [CalVer] versioning standard using the `YY.M.N` format**

...
from src.hardshell.checks.linux.modules import ModuleCheck
    ...
    for system_check in config:
        for check in config[system_check]:
            if not config[system_check][check].get("check_skip"):
                ...
                check_subtype = config[system_check][check].get("check_subtype")
                ...
                if config[system_check][check].get("check_type") == "kernel-module":
                    print(
                    ...
                    pass
                    # Create a SystemCheck instance
                    # print(
                    #     f"Creating SystemCheck: {config[system_check][check].get('command')}"
                    # )
                    ...
                    #         "module_loaded", False
                    #     ),
                    #     mount_boot=config[system_check][check].get("mount_boot", True),
